...
void tst_crypto::randomData_data()
{
    ...
    QTest::addColumn<QVariantMap>("generateRandomDataParams");

    QTest::addColumn<double>("seedRandomDataEntropyEstimate");
    QTest::addColumn<QVariantMap>("seedRandomDataParams");
...
void tst_crypto::randomData()
{
    ...
    QFETCH(QVariantMap, generateRandomDataParams);
    QFETCH(double, seedRandomDataEntropyEstimate);
    QFETCH(QVariantMap, seedRandomDataParams);
