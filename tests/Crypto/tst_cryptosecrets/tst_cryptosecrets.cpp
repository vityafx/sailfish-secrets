...
void tst_cryptosecrets::getPluginInfo()
{
    ...
    QCOMPARE(storagePluginNames.size(), expectedStoragePlugins.size());
    QCOMPARE(QSet<QString>::fromList(storagePluginNames), QSet<QString>::fromList(expectedStoragePlugins));
}
